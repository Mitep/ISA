...
insert into user(broj_logovanja,city,email,first_login,mobile_number,user_name,user_password,user_password_conf,user_role,user_status,user_surname) value (0,'Aaaa','a@a.com',0,'1234','a','a','a',0,0,'a')
